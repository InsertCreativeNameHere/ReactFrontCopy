...
function FormularioRegistro() {
    ...
    const handleSubmit = (e) => {
        ...
        if(!formData.passwd.trim()){
            validationErrors.passwd = "No olvides colocar una contraseña";
        }else if(formData.passwd < 6){
            validationErrors.passwd = "Utiliza una contraseña mas larga por seguridad";
        }

        if(!formData.passwd2 !== formData.passwd){
            validationErrors.passwd2 = "Las contraseñas no coinciden";
        }
            ...
            <div className="md:flex w-full">
              ...
              <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
                      <label htmlFor="passwd" className="text-xs font-semibold px-1">
                        Contraseña:
                      </label>
                      <div className="flex">
                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-12">
                      <label htmlFor="passwd2" className="text-xs font-semibold px-1">
                      ...
                      {errors.passwd2 && <span>{errors.passwd2}</span>}
                    </div>
                  </div>
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
